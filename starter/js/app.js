...
var ShipList = React.createClass({
    ...
    previousPage(){
        this.setState(function(previousState, currentProps){ return{page: previousState.page - 1}});
    },
    ...
    render(){
        return <div><h1>{this.props.ships} Ships</h1>
            ...
            <button onClick={this.nextPage}>NextPage</button></div>;
    }
})
...
var Ship = React.createClass({
    ...
    render() {
        ...
        return <div><li className="list-group-item"><div><span onClick={this.openModal}>{this.props.ship.name}, {cost} Credits</span></div></li>
            <Modal
