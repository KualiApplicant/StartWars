...
/***/ function(module, exports, __webpack_require__) {
	...
	var _underscore = __webpack_require__(157);
	...
	var StartWars = _react2['default'].createClass({
	    ...
	    render: function render() {
	        return _react2['default'].createElement(ShipList, { source: this.props.source });
	    }
	});

	//Should contain and render a list of ships.
	var ShipList = _react2['default'].createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        var self = this;
	        self.ships = [];
	        return _axios2['default'].get(this.props.source + 'starships/').then(function (response) {
	            return self.setState({ ships: response.data.results });
	        });
	    },

	    renderShips: function renderShips() {
	        return _underscore2['default'].map(this.state.ships, function (ship) {
	            return _react2['default'].createElement(Ship, { key: ship.name, ship: ship });
	        });
	    },
	...
	//A ship
	var Ship = _react2['default'].createClass({
	    displayName: 'Ship',
	...
	_react2['default'].render(_react2['default'].createElement(
	    ...
	    _react2['default'].createElement(StartWars, { source: 'http://swapi.co/api/' })
	  ...
	  return new Promise(function (resolve, reject) {
	    try {
	      ...
	      if ((typeof XMLHttpRequest !== 'undefined') || (typeof ActiveXObject !== 'undefined')) {
	        __webpack_require__(163)(resolve, reject, config);
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var urlIsSameOrigin = __webpack_require__(168);
